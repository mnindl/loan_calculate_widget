...
LOANCALCULATEWIDGET.compute = (function () {
  ...
  start_buy_price = 640000,
  start_own_capital = 210000;
  ...
  function setSliderValues(slider, ui) {
    var own_capital_value = $(".slider_own_capital").slider('value'),
        buy_price_value =  $(".slider_buy_price").slider('value');
    if (slider === "buy_price") {
  ...
  function initSlider() {
    ...
    var slider_opt_buy_price = {
      ...
      $(".slider_buy_price").slider("value", start_buy_price);
      $(".slider_own_capital").slider("value", start_own_capital);
  }
  function init() {
    initSlider();
  }
